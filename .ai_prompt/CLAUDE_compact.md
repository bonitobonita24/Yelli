...
Design anti-slop check (design phases)   Run `bash scripts/lint-design.sh --report-only apps/web/src` (V32.17 — surfaces D1–D7 cardinal sins; advisory, never blocks; see .ai_prompt/design-principles.md Pillar 8; Phase 3.3/Parts5-6/Phase 5)
